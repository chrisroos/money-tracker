...
class StatementImporterTest < ActiveSupport::TestCase
  ...
  test 'should import the first transaction' do
    ...
    transaction = Transaction.find_by_source_fit_id('2011010112345678901234567890123')
  ...
  test 'should import the second transaction' do
    ...
    transaction = Transaction.find_by_source_fit_id('2011010212345678901234567890123')
